...
public class ej10 {
	...
	// Respuesta: DoubleEndedQueue. Ya que en esta estructura podemos encolar al final de la fila de forma normal
	// y para las excepcion las personas que tienen prioridad podemos encolar adelante;
}